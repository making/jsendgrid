...
abstract class _MailSettings {
	@Nullable
	abstract Bcc bcc();

	@Nullable
	@JsonProperty("bypass_list_management")
	abstract BypassListManagement bypassListManagement();

	@Nullable
	abstract Footer footer();

	@Nullable
	@JsonProperty("sandbox_mode")
	abstract SandboxMode sandboxMode();

	@Nullable
	@JsonProperty("spam_check")
	abstract SpamCheck spamCheck();
}
